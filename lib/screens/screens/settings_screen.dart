  ...
  Future<void> _updateUserProfile() async {
    if (user != null && user!.photoURL == null) {
      try {
        ...
        await user!
            .reload(); // Recarga el usuario para asegurarte de que tiene la información más reciente
        final googleProfilePic = user!
            .photoURL; // Esta URL viene de Google si el usuario usó Google Sign-In
